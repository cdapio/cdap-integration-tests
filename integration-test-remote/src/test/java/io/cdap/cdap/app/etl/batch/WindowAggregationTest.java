...
/**
 *   Tests WindowAggregation
 */
public class WindowAggregationTest extends ETLTestBase {
  ...
  @Test
  public void testWindowAggregationSpark() throws Exception {
    testWindowAggregation(Engine.SPARK);
  }

  private void testWindowAggregation(Engine spark) throws  Exception {
    ...
    ApplicationId appId = TEST_NAMESPACE.app("windowaggregation-test");
