 ...
 */
public class RBACAuthorizationClient extends AbstractAuthorizer {
  private final AuthorizationClient authorizationClient;
  // this is the cache time out for the authorizer
  private int authorizerCacheTimeout;

  public RBACAuthorizationClient(AuthorizationClient authorizationClient, int authorizerCacheTimeout) {
    this.authorizationClient = authorizationClient;
    this.authorizerCacheTimeout = authorizerCacheTimeout;
  }
