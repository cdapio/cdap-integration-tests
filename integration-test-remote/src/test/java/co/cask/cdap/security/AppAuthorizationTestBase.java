...
public class AppAuthorizationTestBase extends AuthorizationTestBase {
  ...
  public void testDatasetInProgram() throws Exception {
    ...
    authorizationClient.grant(datasetId, new Principal(user2, Principal.PrincipalType.USER),
                              Collections.singleton(Action.READ));
    ...
    try {
      ...
      authorizationClient.revoke(datasetId, new Principal(user2, Principal.PrincipalType.USER),
                                 Collections.singleton(Action.READ));
