...
public abstract class AuthorizationTestBase extends AudiTestBase {
  ...
  protected NamespaceMeta testNamespace = getNamespaceMeta(new NamespaceId("authorization567"), null, null,
                                                           null, null, null, null);
  ...
  protected void userGrant(String user, EntityId entityId, Action action)
    throws SentryUserException, FeatureDisabledException, UnauthenticatedException, IOException, RoleNotFoundException,
  ...
  */
   ...
   * @throws RoleNotFoundException
   */
  protected void userRevoke(String user) throws SentryUserException, FeatureDisabledException, UnauthenticatedException,
    NotFoundException, UnauthorizedException, IOException, RoleNotFoundException {
    try {
  ...
  private static LoginContext kinit() throws LoginException {
    LoginContext lc = new LoginContext(BasicAuthorizationTestBase.class.getSimpleName(), new CallbackHandler() {
