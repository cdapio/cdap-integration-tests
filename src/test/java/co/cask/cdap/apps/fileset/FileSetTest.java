...
public class FileSetTest extends AudiTestBase {
  ...
  public void test() throws Exception {
    ...
    // TODO: should be able to use programManager instead of programClient.waitForStatus
    ProgramClient programClient =
      new ProgramClient(getClientConfig(), getRestClient(), new ApplicationClient(getClientConfig(), getRestClient()));
    programClient.waitForStatus("FileSetExample", ProgramType.SERVICE, "FileSetService",
